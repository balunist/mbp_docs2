...
A separate profile selection **Edge Treatments**, when selected, will include both edge 
treatments (Chamfering and Fillet) and variable depth pockets. These profile features will be 
included as **continuous** lines in the color specified in the color options.
