...
When executing MBP the default option for :ref:`maptype-label` is 
...
requirements then saved as default. See :ref:`Choosing Map Layout <choosingmaplayout-label>` 
for details.
...
See :ref:`Creating Multiple Maps <creatingmultiplemaps-label>` for details.
    
If you are using or plan to include linked components and assemblies in your model than 
see :ref:`Linked Assemblies <linked-label>` for details. 
