...
features and functionality. The additional features are described as MapBoards Pro PLUS in 
the documentation and on the App Store.

There are two primary functions available to subscribers:
...
The new Arrange Type and the post-mapping task are listed in MBP as options. Select 
either, as non-subscribers, and you will be prompted to activate a subscription.  The 
subscription is annual and if allowed to expire your entitlement will revert back to the 
perpetual license features of MapBoards Pro.
